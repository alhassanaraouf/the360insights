        ...
        <Card>
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
              ...
              Rankings Overview - Current Month
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {athleteRanks?.filter((rank: any) => {
                if (!rank.rankingDate) return false;
                const rankDate = new Date(rank.rankingDate);
                const currentDate = new Date();
                return rankDate.getMonth() === currentDate.getMonth() && 
                       rankDate.getFullYear() === currentDate.getFullYear();
